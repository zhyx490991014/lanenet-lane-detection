```
sudo python3 tools/test_lanenet.py --weights_path weights/BiseNetV2_LaneNet_Tusimple_Model_Weights/tusimple_lanenet.ckpt --image_path ./data/tusimple_test_image/0.jpg
```
...
If you want to serve your model via a web server you may be interested in [mortred_model_server](https://github.com/MaybeShewill-CV/mortred_model_server) which is a high performace web server for DNN vision models  🔥🔥🔥
